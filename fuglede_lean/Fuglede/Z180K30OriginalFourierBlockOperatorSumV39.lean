...
theorem z180K30GramOfMatrixV19_eq_toEuclideanLin_v39
...
theorem z180K30OriginalFourierBlockV32_sum_gram_matrix_v39
    {A L : Finset (ZMod 180)}
...
theorem z180K30OriginalFourierBlockV32_sum_gram_operator_apply_v39
    {A L : Finset (ZMod 180)}
    (hSpec : CyclotomicSpectrum 180 A L) (hcard : A.card = 30)
    (data : Z180K30BalancedFibreDataV22 A L) (s : Fin 5)
    ...
    (∑ r : Fin 5,
      ...
      (30 : Complex) • x := by
  simp_rw [z180K30GramOfMatrixV19_eq_toEuclideanLin_v39]
  calc
    (∑ r : Fin 5,
    ...
    _ = Matrix.toEuclideanLin
      ...
      rw [z180K30OriginalFourierBlockV32_sum_gram_matrix_v39
        hSpec hcard data s]
    _ = (30 : Complex) • x := by simp

#print axioms z180K30GramOfMatrixV19_eq_toEuclideanLin_v39
#print axioms z180K30OriginalFourierBlockV32_sum_gram_operator_apply_v39
