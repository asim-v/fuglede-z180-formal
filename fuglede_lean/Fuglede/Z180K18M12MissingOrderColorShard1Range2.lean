...
/-!
Range subshard 2 of the fixed missing-order index 1 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_1_range_2 :
    ∀ z w : ZMod 180,
      60 ≤ z.val ∧ z.val < 90 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_1_range_2
