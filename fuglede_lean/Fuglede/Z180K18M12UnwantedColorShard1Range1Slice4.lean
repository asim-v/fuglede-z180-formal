...
import Fuglede.Z180K18M12UnwantedColorShard1Z51
import Fuglede.Z180K18M12UnwantedColorShard1Z54
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_1_slice_4 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (51 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((51 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_51
  ...
  have hzEq : z = (54 : ZMod 180) := by
    ...
    calc
      ...
      _ = ((54 : ZMod 180).val) := by
        decide
  subst z
  exact z180_k18_m12_unwantedColor_separates_shard_1_z_54
    d hd w hz hw hzw hne

#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_1_slice_4
