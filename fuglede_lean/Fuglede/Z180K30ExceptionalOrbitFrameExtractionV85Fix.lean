...
import Fuglede.Z180K30ExceptionalRawSetEqSemanticsV85Fix
import Mathlib.Tactic

/-!
# Reverse affine witness and complete orbit-frame extraction (V85 Fix)
-/

namespace Fuglede.Z180K30ExceptionalRawV2

@[simp]
theorem affinePoint_inverse_v85Fix
...
theorem affineSet_inverse_v85Fix
  ...
  simp only [affineSet, List.map_map, Function.comp_def,
    affinePoint_inverse_v85Fix unit translation _ hunit, List.map_id]

theorem validSixSetB_affine_of_unit_v85Fix
    (unit translation : RawPoint) (set : RawSet)
    (hunit : unit ∈ units36)
  ...
  have hinjective : Function.Injective (affinePoint unit translation) := by
    ...
    simpa only [affinePoint_inverse_v85Fix unit translation _ hunit] using h
...
theorem reverse_affine_witness_v85Fix :
  ...
  have hvalidAffine :
    ...
    validSixSetB_affine_of_unit_v85Fix unit translation _ hunit hvalidRep
  have heqSymm :
      rawSetEqB V
        (affineSet unit translation
          (z180K30ExceptionalOrbitColumnV4 o)) = true :=
    rawSetEqB_symm_of_valid_v85Fix hvalidV hvalidAffine heq
  ...
  have hinverseSet :
    ...
    exact affineSet_inverse_v85Fix unit translation _ hunit
...
#print axioms reverse_affine_witness_v85Fix
...
theorem z180_k30_orbitFrameExtraction_v85Fix :
    Z180K30OrbitFrameExtractionV84 :=
  z180_k30_orbitFrameExtraction_of_reverse_v85
    reverse_affine_witness_v85Fix

#print axioms z180_k30_orbitFrameExtraction_v85Fix
