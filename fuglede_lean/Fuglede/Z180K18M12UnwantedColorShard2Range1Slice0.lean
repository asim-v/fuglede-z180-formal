...
import Fuglede.Z180K18M12UnwantedColorShard2Z33
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_1_slice_0 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (33 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((33 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_33
  ...
  have hpossible :=
    z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
      d (34 : ZMod 180) hd hz
  have hval : ((34 : ZMod 180).val) = 34 := by
    decide
  simp only [hval] at hpossible
  norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible

#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_1_slice_0
