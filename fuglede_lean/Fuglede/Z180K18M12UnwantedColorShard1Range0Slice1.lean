...
import Fuglede.Z180K18M12UnwantedColorShard1Z6
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_0_slice_1 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (6 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((6 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_6
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_0_slice_1
