...
/-! # Constructive common-frame interfaces for the K30 catalogue (V84 Fix2) -/

namespace Fuglede

open Z180K30ExceptionalRawV2

structure Z180K30OrbitFrameV84Fix2 (V : RawSet) where
  o : Fin 8
  unit : RawPoint
...
def Z180K30OrbitFrameExtractionV84Fix2 : Type :=
  ∀ V : RawSet, validSixSetB V = true → orbitCoveredB V = true →
    Z180K30OrbitFrameV84Fix2 V

def Z180K30FramedCandidateExtractionV84Fix2 : Prop :=
...
def z180_k30_framedStarCatalogue_of_interfaces_v84Fix2
    (hframe : Z180K30OrbitFrameExtractionV84Fix2)
    (hcandidates : Z180K30FramedCandidateExtractionV84Fix2) :
...
def z180_k30_fiveGramStar_catalogue_of_orbitCovered_v84Fix2
    (hframe : Z180K30OrbitFrameExtractionV84Fix2)
    (hcandidates : Z180K30FramedCandidateExtractionV84Fix2)
    {U : Fin 5 → RawSet} {V : RawSet}
...
#print axioms z180_k30_framedStarCatalogue_of_interfaces_v84Fix2
#print axioms z180_k30_fiveGramStar_catalogue_of_orbitCovered_v84Fix2
