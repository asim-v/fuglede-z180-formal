...
structure Z180K30GramOperatorDataV11 where
...
theorem Z180K30GramOperatorDataV11.sum_eigenvalue_eq_thirty
    (data : Z180K30GramOperatorDataV11) (k : Fin 6) :
...
theorem Z180K30GramOperatorDataV11.common_cross_product
    (data : Z180K30GramOperatorDataV11) (k : Fin 6) :
...
theorem Z180K30GramOperatorDataV11.sum_eigenvalue_eq_thirtySix
    (data : Z180K30GramOperatorDataV11) (r : Fin 5) :
  ...
  have hdiag (k : Fin 6) :
    ...
    simp [LinearMap.toMatrix_apply, data.core.gram_apply_jointBasis]
  rw [Matrix.trace] at ht
  simp_rw [hdiag] at ht
  exact_mod_cast ht

noncomputable def Z180K30GramOperatorDataV11.toJointEigenvalueData
    (data : Z180K30GramOperatorDataV11) :
...
theorem Z180K30GramOperatorDataV11.dichotomy
    (data : Z180K30GramOperatorDataV11) :
...
#print axioms Z180K30GramOperatorDataV11.dichotomy
