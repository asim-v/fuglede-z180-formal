...
theorem z180K30FifthSlice_phase_normalized_eq_v50
  ...
  rw [z180K30FifthSliceFourierSumV34_eq_phase_mul_fiveLevelV47
      X r d,
    z180K30FifthSliceFourierSumV34_eq_phase_mul_fiveLevelV47
      X u d]
  simp only [← mul_assoc, hcancel, one_mul]
  exact heq _ _

theorem z180K30L_difference_fifthCoord_v50
    {A L : Finset (ZMod 180)}
...
theorem z180K30A_difference_fifthCoord_v50
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L)
    (r u : Fin 5) (i k : Fin 6) :
    crt180FifthCoord (toCRT180
...
theorem z180K30OriginalFourierBlockV32_phased_column_cross_v50
    {A L : Finset (ZMod 180)}
  ...
  have hcoord : crt180FifthCoord (toCRT180 d) =
      (t.val : ZMod 5) - (s.val : ZMod 5) := by
    exact z180K30L_difference_fifthCoord_v50 data s t j k
  ...
  have hphase := z180K30FifthSlice_phase_normalized_eq_v50
    A d hfifth hzero r u
  simpa only [d, hcoord] using hphase

theorem z180K30OriginalFourierBlockV32_phased_row_cross_v50
    {A L : Finset (ZMod 180)}
    (hSpec : CyclotomicSpectrum 180 A L)
    (data : Z180K30BalancedFibreDataV22 A L)
  ...
  have hcoord : crt180FifthCoord (toCRT180 d) =
      (r.val : ZMod 5) - (u.val : ZMod 5) := by
    exact z180K30A_difference_fifthCoord_v50 data r u i k
  have hfifth : crt180FifthCoord (toCRT180 d) ≠ 0 := by
    rw [hcoord]
    intro hz
...
#print axioms z180K30FifthSlice_phase_normalized_eq_v50
#print axioms z180K30OriginalFourierBlockV32_phased_column_cross_v50
#print axioms z180K30OriginalFourierBlockV32_phased_row_cross_v50
