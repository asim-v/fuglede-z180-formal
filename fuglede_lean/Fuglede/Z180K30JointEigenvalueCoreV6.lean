...
theorem Z180K30PositiveCommutingGramFamilyV6.gram_apply_jointBasis
    (data : Z180K30PositiveCommutingGramFamilyV6)
    (k : Fin 6) (r : Fin 5) :
  ...
  simpa only [smul_eq_mul] using happly

theorem Z180K30PositiveCommutingGramFamilyV6.eigenvalue_nonnegative
    (data : Z180K30PositiveCommutingGramFamilyV6)
    (k : Fin 6) (r : Fin 5) :
  ...
  have hvec : HasEigenvector (data.family.gram r)
    ...
    simpa only [smul_eq_mul] using data.gram_apply_jointBasis k r
  exact eigenvalue_nonneg_of_nonneg
    (hasEigenvalue_of_hasEigenvector hvec) (data.nonnegative r)

#print axioms Z180K30PositiveCommutingGramFamilyV6.eigenvalue_nonnegative
