...
import Fuglede.Z180K18M12UnwantedColorShard1Z90
import Fuglede.Z180K18M12UnwantedColorShard1Z93
import Fuglede.Z180K18M12UnwantedColorShard1Z94
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_3_slice_0 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (90 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((90 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_90
    ...
    have hzEq : z = (93 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((93 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_93
      d hd w hz hw hzw hne
  ...
  have hzEq : z = (94 : ZMod 180) := by
    ...
    calc
      ...
      _ = ((94 : ZMod 180).val) := by
        decide
  subst z
  exact z180_k18_m12_unwantedColor_separates_shard_1_z_94
    d hd w hz hw hzw hne

#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_3_slice_0
