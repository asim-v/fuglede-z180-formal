...
import Fuglede.Z180K18M12UnwantedColorShard2Z84
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_4 :
    ∀ d : ZMod 180,
  ...
  · have hzVal : z.val = 82 := (Nat.le_antisymm (Nat.le_of_lt_succ h83) (Nat.le_of_not_gt h82))
    ...
    have hpossible :=
      z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
        d (82 : ZMod 180) hd hz
    have hval : ((82 : ZMod 180).val) = 82 := by
      decide
    simp only [hval] at hpossible
    norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible
  ...
  have hzEq : z = (84 : ZMod 180) := by
    ...
    calc
      ...
      _ = ((84 : ZMod 180).val) := by
        decide
  subst z
  exact z180_k18_m12_unwantedColor_separates_shard_2_z_84
    d hd w hz hw hzw hne

#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_4
