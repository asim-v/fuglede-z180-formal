...
/-! Literal accepted-pair coverage shard 191; no choose/drop reconstruction. -/

namespace Fuglede.Z180K30ExceptionalRawV2

def z180K30ExceptionalLiteralAcceptedPairsV85Shard191 :
    List (RawSet × RawSet) :=
  [
...
theorem z180_k30_exceptional_literal_accepted_pairs_v85_shard191 :
    z180K30ExceptionalLiteralAcceptedPairsV85Shard191.all
