...
/-! Literal accepted-pair coverage shard 159; no choose/drop reconstruction. -/

namespace Fuglede.Z180K30ExceptionalRawV2

def z180K30ExceptionalLiteralAcceptedPairsV85Shard159 :
    List (RawSet × RawSet) :=
  [
...
theorem z180_k30_exceptional_literal_accepted_pairs_v85_shard159 :
    z180K30ExceptionalLiteralAcceptedPairsV85Shard159.all
