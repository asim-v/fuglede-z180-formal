import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicLeaf18PilotV97
import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicKeyDisjointRow19PilotV97

/-! Pairwise key-disjointness row 18; every decision compares two chunks of at most ten keys. -/

namespace Fuglede.Z180K30ExceptionalRawV2

theorem z180_k30_projective_d4_u_key_disjoint_row_18_pilot_v97 :
    List.Pairwise List.Disjoint [z180K30ProjectiveD4ULeaf18KeysPilotV97,
  ...
  · intro values hvalues
    ...
    rcases hvalues with (rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl) <;>
      (rw [List.disjoint_left]; decide)
  · exact z180_k30_projective_d4_u_key_disjoint_row_19_pilot_v97
