...
import Fuglede.Z180K18M12UnwantedColorShard2Z87
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_5 :
    ∀ d : ZMod 180,
  ...
  · have hzVal : z.val = 86 := (Nat.le_antisymm (Nat.le_of_lt_succ h87) (Nat.le_of_not_gt h86))
    ...
    have hpossible :=
      z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
        d (86 : ZMod 180) hd hz
    have hval : ((86 : ZMod 180).val) = 86 := by
      decide
    simp only [hval] at hpossible
    norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible
    ...
    have hzEq : z = (87 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((87 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_87
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_5
