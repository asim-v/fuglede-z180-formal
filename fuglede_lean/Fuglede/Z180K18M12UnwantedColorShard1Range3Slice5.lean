...
import Fuglede.Z180K18M12UnwantedColorShard1Z118
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_3_slice_5 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (118 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((118 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_118
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_3_slice_5
