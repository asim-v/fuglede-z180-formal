...
/-!
Range subshard 1 of the fixed missing-order index 4 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_4_range_1 :
    ∀ z w : ZMod 180,
      30 ≤ z.val ∧ z.val < 60 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_4_range_1
