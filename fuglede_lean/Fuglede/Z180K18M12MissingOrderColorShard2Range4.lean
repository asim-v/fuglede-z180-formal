...
/-!
Range subshard 4 of the fixed missing-order index 2 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_2_range_4 :
    ∀ z w : ZMod 180,
      120 ≤ z.val ∧ z.val < 150 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_2_range_4
