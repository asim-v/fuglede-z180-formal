...
import Fuglede.Z180K18M12UnwantedColorShard1Z42
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_1_slice_2 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (42 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((42 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_42
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_1_slice_2
