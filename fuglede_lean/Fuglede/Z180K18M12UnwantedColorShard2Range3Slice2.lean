...
import Fuglede.Z180K18M12UnwantedColorShard2Z102
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_3_slice_2 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (102 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((102 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_102
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_3_slice_2
