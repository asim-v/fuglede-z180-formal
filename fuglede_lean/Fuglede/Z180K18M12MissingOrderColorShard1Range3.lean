...
/-!
Range subshard 3 of the fixed missing-order index 1 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_1_range_3 :
    ∀ z w : ZMod 180,
      90 ≤ z.val ∧ z.val < 120 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_1_range_3
