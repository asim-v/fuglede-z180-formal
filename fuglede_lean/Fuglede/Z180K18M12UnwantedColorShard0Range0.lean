...
/-!
Range subshard 0 of the fixed unwanted-order index 0 check.
The first free clique vertex satisfies `z.val < 30`.
...
theorem z180_k18_m12_unwantedColor_separates_shard_0_range_0 :
    ∀ d : ZMod 180,
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_0_range_0
