...
import Fuglede.Z180K18M12UnwantedColorShard2Z141
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_4_slice_4 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (141 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((141 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_141
  ...
  · have hzVal : z.val = 142 := (Nat.le_antisymm (Nat.le_of_lt_succ h143) (Nat.le_of_not_gt h142))
    ...
    have hpossible :=
      z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
        d (142 : ZMod 180) hd hz
    have hval : ((142 : ZMod 180).val) = 142 := by
      decide
    simp only [hval] at hpossible
    norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_4_slice_4
