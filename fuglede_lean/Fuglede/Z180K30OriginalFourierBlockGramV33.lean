...
noncomputable def z180K30FifthSliceFourierSumV33
    (X : Finset (ZMod 180)) (r : Fin 5) (d : ZMod 180) : Complex :=
  ∑ x ∈ z180K30FifthSlice X (r.val : ZMod 5),
    ZMod.stdAddChar (x * d)

theorem z180K30OriginalFourierBlockV32_conjTranspose_mul_apply
    {A L : Finset (ZMod 180)}
    ...
    (Matrix.conjTranspose (z180K30OriginalFourierBlockV32 data r s) *
      ...
      z180K30FifthSliceFourierSumV33 A r
  ...
  simp_rw [hterm]
  unfold z180K30FifthSliceFourierSumV33
...
#print axioms z180K30OriginalFourierBlockV32_conjTranspose_mul_apply
