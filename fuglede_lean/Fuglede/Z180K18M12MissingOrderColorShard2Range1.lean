...
/-!
Range subshard 1 of the fixed missing-order index 2 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_2_range_1 :
    ∀ z w : ZMod 180,
      30 ≤ z.val ∧ z.val < 60 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_2_range_1
