...
theorem z180K30_projection30_eq_iff_sixthDigit_cast5_eq
  ...
  have hxrec := z180K30_sixthDigit_reconstruction x
  have hyrec := z180K30_sixthDigit_reconstruction y
  have hpref :
      z180K30Projection30
          ((z180K30Projection6 x).val : ZMod 180) =
        z180K30Projection30
          ((z180K30Projection6 y).val : ZMod 180) := by
    rw [hcoord]
  constructor
  · intro hxy
    have hsum :
        z180K30Projection30
            (((z180K30Projection6 x).val : ZMod 180) +
              z30K5ScaleSix180 (z180K30SixthDigit x)) =
          z180K30Projection30
            (((z180K30Projection6 y).val : ZMod 180) +
              z30K5ScaleSix180 (z180K30SixthDigit y)) := by
      rw [hxrec, hyrec]
      exact hxy
    rw [map_add, map_add, hpref] at hsum
    apply (z180K30_projection30_scaleSix_eq_iff_cast5_eq _ _).mp
    exact add_left_cancel hsum
  · intro hdigit
    have hscale :=
      (z180K30_projection30_scaleSix_eq_iff_cast5_eq _ _).mpr hdigit
    have hsum :
        z180K30Projection30
            (((z180K30Projection6 x).val : ZMod 180) +
              z30K5ScaleSix180 (z180K30SixthDigit x)) =
          z180K30Projection30
            (((z180K30Projection6 y).val : ZMod 180) +
              z30K5ScaleSix180 (z180K30SixthDigit y)) := by
      rw [map_add, map_add, hpref, hscale]
    rwa [hxrec, hyrec] at hsum
