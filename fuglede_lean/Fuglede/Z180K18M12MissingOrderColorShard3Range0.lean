...
/-!
Range subshard 0 of the fixed missing-order index 3 check.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_3_range_0 :
    ∀ z w : ZMod 180,
      z.val < 30 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_3_range_0
