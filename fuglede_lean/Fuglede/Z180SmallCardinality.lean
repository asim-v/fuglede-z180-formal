...
/-- A tiling in a surjective homomorphic image lifts provided the first
factor has no collisions. -/
theorem lift_tiles_of_surjective (φ : G →+ H) (hφ : Function.Surjective φ)
    (A : Finset G) (C : Finset H)
