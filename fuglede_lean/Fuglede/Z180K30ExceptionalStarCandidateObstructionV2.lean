...
/-! Propositional form of the exact non-H Gram-coordinate audits (V2). -/

namespace Fuglede.Z180K30ExceptionalRawV2

theorem z180K30PmSix_of_audit_v2
...
theorem z180K30PairType_of_audit_v2
  ...
  have hb := (List.all_eq_true.mp haudit) U hmem
  simp only [z180K30PairTypeB, Bool.or_eq_true, Bool.and_eq_true,
    beq_iff_eq] at hb
  rcases hb with hfirst | hthird
  · rcases hfirst with hfirst | hsecond
    · exact Or.inl hfirst
    · exact Or.inr (Or.inl hsecond)
  · exact Or.inr (Or.inr hthird)

theorem z180_k30_no_fiveGram_coordinate_sum_of_pmSix_audit_v2
  ...
  · exact z180K30PmSix_of_audit_v2 haudit (hmem 0)
  · exact z180K30PmSix_of_audit_v2 haudit (hmem 1)
  · exact z180K30PmSix_of_audit_v2 haudit (hmem 2)
  · exact z180K30PmSix_of_audit_v2 haudit (hmem 3)
  · exact z180K30PmSix_of_audit_v2 haudit (hmem 4)

theorem z180_k30_no_fiveGram_coordinate_pair_sum_of_audit_v2
  ...
  · exact z180K30PairType_of_audit_v2 haudit (hmem 0)
  · exact z180K30PairType_of_audit_v2 haudit (hmem 1)
  · exact z180K30PairType_of_audit_v2 haudit (hmem 2)
  · exact z180K30PairType_of_audit_v2 haudit (hmem 3)
  · exact z180K30PairType_of_audit_v2 haudit (hmem 4)

#print axioms z180_k30_no_fiveGram_coordinate_sum_of_pmSix_audit_v2
#print axioms z180_k30_no_fiveGram_coordinate_pair_sum_of_audit_v2
