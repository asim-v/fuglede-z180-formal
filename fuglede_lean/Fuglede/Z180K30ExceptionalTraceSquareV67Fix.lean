...
theorem Z180K30ExceptionalGramEigenvalueData.sum_sq_eq_936_v67Fix
...
theorem z180_k30_joint_square_coordinate_v67Fix
...
theorem z180_k30_joint_trace_square_v67Fix
  ...
  apply Finset.sum_congr rfl
  intro k _hk
  exact z180_k30_joint_square_coordinate_v67Fix core r k

theorem z180_k30_exceptional_trace_square_eq_936_v67Fix
    (core : Z180K30PositiveCommutingGramFamilyV7)
    (hex : Z180K30ExceptionalGramEigenvalueData core.eigenvalue)
    (r : Fin 5) :
    LinearMap.trace Complex Z180K30JointSpaceV5
      ((core.family.gram r).comp (core.family.gram r)) = 936 := by
  rw [z180_k30_joint_trace_square_v67Fix]
  exact_mod_cast hex.sum_sq_eq_936_v67Fix r

#print axioms Z180K30ExceptionalGramEigenvalueData.sum_sq_eq_936_v67Fix
#print axioms z180_k30_exceptional_trace_square_eq_936_v67Fix
