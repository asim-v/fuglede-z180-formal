...
/-! # Set-level exclusion of cyclotomic order forty-five at `k = 12` -/
...
theorem z180_k12_m6_not_cyclotomic_fortyfive_high
    {A : Finset (ZMod 180)}
    (hcard : A.card = 12)
  ...
  have hz := projection36_phi9_remainders_zero_of_mod_five_dvd_high _ hlo hhi hmod
  have hprojected :=
    cyclotomic_nine_dvd_projection36Indicator_of_remainders_zero_high _ hz
...
#print axioms z180_k12_m6_not_cyclotomic_fortyfive_high
