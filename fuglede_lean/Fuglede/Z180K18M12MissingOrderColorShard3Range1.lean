...
/-!
Range subshard 1 of the fixed missing-order index 3 check.
The first clique vertex satisfies `30 ≤ z.val ∧ z.val < 60`.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_3_range_1 :
    ∀ z w : ZMod 180,
      30 ≤ z.val ∧ z.val < 60 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_3_range_1
