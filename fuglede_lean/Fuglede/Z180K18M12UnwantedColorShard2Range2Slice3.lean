...
import Fuglede.Z180K18M12UnwantedColorShard2Z78
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_3 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (78 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((78 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_78
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_3
