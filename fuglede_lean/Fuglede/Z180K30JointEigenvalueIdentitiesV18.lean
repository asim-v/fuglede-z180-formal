import Fuglede.Z180K30JointTracePilotV17
...
structure Z180K30GramOperatorDataV18 where
...
theorem Z180K30GramOperatorDataV18.sum_eigenvalue_eq_thirty
    (data : Z180K30GramOperatorDataV18) (k : Fin 6) :
  ...
  have hone : inner Complex (data.core.family.jointBasis k)
      (data.core.family.jointBasis k) = 1 :=
    data.core.family.jointBasis.inner_eq_one k
  rw [inner_sum] at hinner
  simp_rw [inner_smul_right, hone, mul_one] at hinner
  exact_mod_cast hinner

theorem Z180K30GramOperatorDataV18.common_cross_product
    (data : Z180K30GramOperatorDataV18) (k : Fin 6) :
    ∃ q : Real, ∀ r s, r ≠ s ->
...
theorem Z180K30GramOperatorDataV18.sum_eigenvalue_eq_thirtySix
    (data : Z180K30GramOperatorDataV18) (r : Fin 5) :
    (Finset.univ.sum fun k : Fin 6 => data.core.eigenvalue k r) = 36 :=
  z180_k30_joint_trace_pilot_v17 data.core r (data.trace_eq r)

noncomputable def Z180K30GramOperatorDataV18.toJointEigenvalueData
    (data : Z180K30GramOperatorDataV18) :
...
theorem Z180K30GramOperatorDataV18.dichotomy
    (data : Z180K30GramOperatorDataV18) :
...
#print axioms Z180K30GramOperatorDataV18.dichotomy
