...
import Fuglede.Z180K18M12UnwantedColorShard1Z132
import Fuglede.Z180K18M12UnwantedColorShard1Z134
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_2 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (132 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((132 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_132
  ...
  have hzEq : z = (134 : ZMod 180) := by
    ...
    calc
      ...
      _ = ((134 : ZMod 180).val) := by
        decide
  subst z
  exact z180_k18_m12_unwantedColor_separates_shard_1_z_134
    d hd w hz hw hzw hne

#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_2
