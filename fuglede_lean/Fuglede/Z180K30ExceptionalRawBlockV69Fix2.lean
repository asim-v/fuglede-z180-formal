...
This second repaired module unfolds the local CRT phase value explicitly
and proves the zero-frequency pairing by the CRT equivalence's `map_zero`.
-/
...
theorem z180K30Unit29_mul_injective_v69Fix2 :
...
noncomputable def z180K30ExceptionalRawRowPointV69Fix2
    {A L : Finset (ZMod 180)}
...
noncomputable def z180K30ExceptionalRawColumnPointV69Fix2
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L)
...
@[simp]
theorem z180K30ExceptionalRawRowPointV69Fix2_val
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L)
    (r : Fin 5) (a : Fin 6) :
    ((z180K30ExceptionalRawRowPointV69Fix2 data r a).val : ZMod 36) =
      (29 : ZMod 36) *
        z180K30ProjectedFibreEnumV57 A r (data.cardA r) a := by
  exact z180K30RawPointV63Fix_val _

@[simp]
theorem z180K30ExceptionalRawColumnPointV69Fix2_val
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L)
    (s : Fin 5) (l : Fin 6) :
    ((z180K30ExceptionalRawColumnPointV69Fix2 data s l).val : ZMod 36) =
      z180K30ProjectedFibreEnumV57 L s (data.cardL s) l := by
  exact z180K30RawPointV63Fix_val _

/-- Twisted projected row fibre `U_r`, in the raw certificate format. -/
noncomputable def z180K30ExceptionalRawRowV69Fix2
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L) (r : Fin 5) : RawSet :=
  List.ofFn fun a : Fin 6 =>
    z180K30ExceptionalRawRowPointV69Fix2 data r a

/-- Untwisted projected column fibre `V_s`, in the raw certificate format. -/
noncomputable def z180K30ExceptionalRawColumnV69Fix2
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L) (s : Fin 5) : RawSet :=
  z180K30RawFibreV63Fix L s (data.cardL s)

theorem z180K30ExceptionalRawRowV69Fix2_nodup
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L) (r : Fin 5) :
    (z180K30ExceptionalRawRowV69Fix2 data r).Nodup := by
  unfold z180K30ExceptionalRawRowV69Fix2
  apply List.nodup_ofFn.mpr
  intro a b hab
  apply z180K30ProjectedFibreEnumV57_injective A r (data.cardA r)
  apply z180K30Unit29_mul_injective_v69Fix2
  have hvals :=
    congrArg (fun p : RawPoint => (p.val : ZMod 36)) hab
  simpa only [z180K30ExceptionalRawRowPointV69Fix2_val] using hvals

private theorem eraseDups_eq_self_of_nodup_v69Fix2
...
theorem z180K30ExceptionalRawRowV69Fix2_validSixSetB
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L) (r : Fin 5) :
    validSixSetB (z180K30ExceptionalRawRowV69Fix2 data r) = true := by
  unfold validSixSetB
  rw [eraseDups_eq_self_of_nodup_v69Fix2
    (z180K30ExceptionalRawRowV69Fix2_nodup data r)]
  simp [z180K30ExceptionalRawRowV69Fix2]

theorem z180K30ExceptionalRawColumnV69Fix2_validSixSetB
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L) (s : Fin 5) :
    validSixSetB (z180K30ExceptionalRawColumnV69Fix2 data s) = true := by
  simpa [z180K30ExceptionalRawColumnV69Fix2] using
    z180K30RawFibreV63Fix_validSixSetB L s (data.cardL s)

/-- The fifth-coordinate component of a block entry is exactly its V51
dephasing phase. -/
private theorem z180K30FifthPhaseCharacterV69Fix2
    ...
    _ = ZMod.stdAddChar
      ...
      have hzero :
        ...
        change ZMod.stdAddChar
          (fromCRT180 ((0 : CRT180) * toCRT180 x)) = 1
        rw [zero_mul]
        have hfromZero : fromCRT180 (0 : CRT180) = 0 :=
...
`ZMod 36` character. -/
private theorem z180K30DephasedCharacterV69Fix2
  ...
  have hphase :
      ZMod.stdAddChar (x * c) =
        ZMod.stdAddChar
          ((r.val : ZMod 5) * (s.val : ZMod 5)) := by
    simpa only [c] using z180K30FifthPhaseCharacterV69Fix2 x r s hx
  have hsplit :
      ZMod.stdAddChar (x * y) =
        ZMod.stdAddChar
...
theorem z180K30DephasedFourierBlockV51_apply_raw_v69Fix2
    {A L : Finset (ZMod 180)}
    (data : Z180K30BalancedFibreDataV22 A L)
    (r s : Fin 5) (a l : Fin 6) :
    z180K30DephasedFourierBlockV51 data r s a l =
      ZMod.stdAddChar
        (((z180K30ExceptionalRawRowPointV69Fix2 data r a).val : ZMod 36) *
          ((z180K30ExceptionalRawColumnPointV69Fix2 data s l).val : ZMod 36)) := by
  simp only [z180K30DephasedFourierBlockV51, Matrix.smul_apply,
    ...
    z180K30ExceptionalRawRowPointV69Fix2_val,
    z180K30ExceptionalRawColumnPointV69Fix2_val]
  exact z180K30DephasedCharacterV69Fix2
...
#print axioms z180K30ExceptionalRawRowV69Fix2_validSixSetB
#print axioms z180K30ExceptionalRawColumnV69Fix2_validSixSetB
#print axioms z180K30DephasedFourierBlockV51_apply_raw_v69Fix2
