...
import Fuglede.Z180K18M12UnwantedColorShard1Z146
import Fuglede.Z180K18M12UnwantedColorShard1Z147
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_5 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (146 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((146 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_146
    ...
    have hzEq : z = (147 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((147 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_147
      d hd w hz hw hzw hne
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_5
