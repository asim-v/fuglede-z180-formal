...
import Fuglede.Z180K18M12UnwantedColorShard2Z60
...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_0 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (60 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((60 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_2_z_60
  ...
  · have hzVal : z.val = 62 := (Nat.le_antisymm (Nat.le_of_lt_succ h63) (Nat.le_of_not_gt h62))
    ...
    have hpossible :=
      z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
        d (62 : ZMod 180) hd hz
    have hval : ((62 : ZMod 180).val) = 62 := by
      decide
    simp only [hval] at hpossible
    norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_2_slice_0
