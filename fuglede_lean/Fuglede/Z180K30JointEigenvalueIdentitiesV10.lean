...
structure Z180K30GramOperatorDataV10 where
  core : Z180K30PositiveCommutingGramFamilyV7
  sum_apply :
    forall x, (Finset.univ.sum fun r : Fin 5 => core.family.gram r x) =
      (30 : Complex) • x
...
theorem Z180K30GramOperatorDataV10.sum_eigenvalue_eq_thirty
    (data : Z180K30GramOperatorDataV10) (k : Fin 6) :
  ...
  have hcomplex :
      (Finset.univ.sum fun r : Fin 5 =>
        (data.core.eigenvalue k r : Complex)) = 30 := by
    simpa using hinner
  exact_mod_cast hcomplex

theorem Z180K30GramOperatorDataV10.common_cross_product
    (data : Z180K30GramOperatorDataV10) (k : Fin 6) :
...
theorem Z180K30GramOperatorDataV10.sum_eigenvalue_eq_thirtySix
    (data : Z180K30GramOperatorDataV10) (r : Fin 5) :
  ...
  have hcomplex :
      (Finset.univ.sum fun k : Fin 6 =>
        (data.core.eigenvalue k r : Complex)) = 36 := by
    simpa [Matrix.trace, LinearMap.toMatrix_apply,
      data.core.gram_apply_jointBasis] using ht
  exact_mod_cast hcomplex

noncomputable def Z180K30GramOperatorDataV10.toJointEigenvalueData
    (data : Z180K30GramOperatorDataV10) :
...
theorem Z180K30GramOperatorDataV10.dichotomy
    (data : Z180K30GramOperatorDataV10) :
    Or (forall k, Z180K30GramNormalScalar (data.core.eigenvalue k))
      (Z180K30ExceptionalGramEigenvalueData data.core.eigenvalue) :=
  data.toJointEigenvalueData.dichotomy

#print axioms Z180K30GramOperatorDataV10.dichotomy
