...
theorem z180K30DephasedGramOperator_eq_six_smul_id_v55
    {A L : Finset (ZMod 180)}
...
theorem z180K30OriginalGramOperator_eq_six_smul_id_v55
    {A L : Finset (ZMod 180)}
    (hSpec : CyclotomicSpectrum 180 A L) (hcard : A.card = 30)
    (data : Z180K30BalancedFibreDataV22 A L) (s r : Fin 5)
    (hnormal : ∀ k, Z180K30GramNormalScalar
  ...
  exact z180K30DephasedGramOperator_eq_six_smul_id_v55
    hSpec hcard data s r hnormal

#print axioms z180K30DephasedGramOperator_eq_six_smul_id_v55
#print axioms z180K30OriginalGramOperator_eq_six_smul_id_v55
