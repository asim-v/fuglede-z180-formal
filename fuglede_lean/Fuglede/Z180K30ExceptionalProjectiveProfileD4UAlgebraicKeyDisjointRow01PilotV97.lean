import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicLeaf01PilotV97
import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicKeyDisjointRow02PilotV97

/-! Pairwise key-disjointness row 1; every decision compares two chunks of at most ten keys. -/

namespace Fuglede.Z180K30ExceptionalRawV2

theorem z180_k30_projective_d4_u_key_disjoint_row_01_pilot_v97 :
    List.Pairwise List.Disjoint [z180K30ProjectiveD4ULeaf01KeysPilotV97,
  ...
  · intro values hvalues
    ...
    rcases hvalues with (rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl) <;>
      (rw [List.disjoint_left]; decide)
  · exact z180_k30_projective_d4_u_key_disjoint_row_02_pilot_v97
