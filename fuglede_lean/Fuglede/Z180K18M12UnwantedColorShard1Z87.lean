...
theorem z180_k18_m12_unwantedColor_separates_shard_1_z_87 :
    ∀ d : ZMod 180,
      ...
      ∀ w : ZMod 180,
        ...
        (87 : ZMod 180) ≠ w →
        z180K18M12UnwantedColor (1 : Fin 3) d (87 : ZMod 180) ≠
          z180K18M12UnwantedColor (1 : Fin 3) d w := by
  decide

#print axioms z180_k18_m12_unwantedColor_separates_shard_1_z_87
