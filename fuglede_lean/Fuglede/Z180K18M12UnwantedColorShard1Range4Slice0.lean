...
import Fuglede.Z180K18M12UnwantedColorShard1Z120
import Fuglede.Z180K18M12UnwantedColorShard1Z122
import Fuglede.Z180K18M12UnwantedColorShard1Z123
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_0 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (120 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((120 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_120
    ...
    have hzEq : z = (122 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((122 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_122
      d hd w hz hw hzw hne
    ...
    have hzEq : z = (123 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((123 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_123
      d hd w hz hw hzw hne
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_0
