...
theorem z180K30GramOfMatrixV19_eq_toEuclideanLin
...
theorem z180K30OriginalFourierBlockV32_sum_gram_matrix
    {A L : Finset (ZMod 180)}
  ...
  rw [z180K30OriginalFourierBlockV32_sum_gram_apply hSpec hcard data s j k]
  by_cases hjk : j = k
  · subst k
    simp
  · simp [hjk]

theorem z180K30OriginalFourierBlockV32_sum_gram_operator_apply
    {A L : Finset (ZMod 180)}
    (hSpec : CyclotomicSpectrum 180 A L) (hcard : A.card = 30)
    (data : Z180K30BalancedFibreDataV22 A L) (s : Fin 5)
    ...
    (∑ r : Fin 5,
      ...
      (30 : Complex) • x := by
  simp_rw [z180K30GramOfMatrixV19_eq_toEuclideanLin]
  calc
    (∑ r : Fin 5,
    ...
    _ = Matrix.toEuclideanLin
      ...
      rw [z180K30OriginalFourierBlockV32_sum_gram_matrix
        hSpec hcard data s]
    _ = (30 : Complex) • x := by simp

#print axioms z180K30GramOfMatrixV19_eq_toEuclideanLin
#print axioms z180K30OriginalFourierBlockV32_sum_gram_operator_apply
