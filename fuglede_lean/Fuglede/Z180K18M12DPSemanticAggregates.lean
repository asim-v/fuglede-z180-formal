import Fuglede.Z180K18M12DPSemanticAggregate0
import Fuglede.Z180K18M12DPSemanticAggregate1
import Fuglede.Z180K18M12DPSemanticAggregate2

/-! Proof-only aggregator for the three balance leaves. -/

namespace Fuglede

theorem z180_k18_m12_dp_aggregates
  ...
  obtain ⟨eX0, eY0, hX0, hY0⟩ := z180_k18_m12_dp_aggregate0 b d
  obtain ⟨eX1, eY1, hX1, hY1⟩ := z180_k18_m12_dp_aggregate1 b d
  obtain ⟨eX2, eY2, hX2, hY2⟩ := z180_k18_m12_dp_aggregate2 b d
  exact ⟨eX0, eY0, eX1, eY1, eX2, eY2,
    hX0, hY0, hX1, hY1, hX2, hY2⟩

#print axioms z180_k18_m12_dp_aggregates
