...
The first free clique vertex is the literal `(106 : ZMod 180)`;
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_z_106 :
    ∀ d : ZMod 180,
      frequencyOrder 180 d = z180K18M12UnwantedOrder (1 : Fin 3) →
      ∀ w : ZMod 180,
        Z180K18M12UnwantedCommonNeighbor d (106 : ZMod 180) →
        Z180K18M12UnwantedCommonNeighbor d w →
        frequencyOrder 180 ((106 : ZMod 180) - w) ∈
          z180K18M12EnvelopeOrders →
        (106 : ZMod 180) ≠ w →
        z180K18M12UnwantedColor (1 : Fin 3) d (106 : ZMod 180) ≠
          z180K18M12UnwantedColor (1 : Fin 3) d w := by
  decide

#print axioms z180_k18_m12_unwantedColor_separates_shard_1_z_106
