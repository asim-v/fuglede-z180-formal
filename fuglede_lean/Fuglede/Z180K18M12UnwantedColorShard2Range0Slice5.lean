...
theorem z180_k18_m12_unwantedColor_separates_shard_2_range_0_slice_5 :
    ∀ d : ZMod 180,
  ...
  · have hzVal : z.val = 26 := (Nat.le_antisymm (Nat.le_of_lt_succ h27) (Nat.le_of_not_gt h26))
    ...
    have hpossible :=
      z180_k18_m12_unwantedCommonNeighbor_val_mem_shard_2
        d (26 : ZMod 180) hd hz
    have hval : ((26 : ZMod 180).val) = 26 := by
      decide
    simp only [hval] at hpossible
    norm_num [z180K18M12UnwantedCommonPossibleValues2] at hpossible
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_2_range_0_slice_5
