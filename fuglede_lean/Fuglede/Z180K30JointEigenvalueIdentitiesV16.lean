...
structure Z180K30GramOperatorDataV16 where
...
theorem Z180K30GramOperatorDataV16.sum_eigenvalue_eq_thirty
    (data : Z180K30GramOperatorDataV16) (k : Fin 6) :
  ...
  have hone : inner Complex (data.core.family.jointBasis k)
    ...
    exact data.core.family.jointBasis.inner_eq_one k
  rw [inner_sum] at hinner
  simp_rw [inner_smul_right, hone, mul_one] at hinner
  exact_mod_cast hinner

theorem Z180K30GramOperatorDataV16.common_cross_product
    (data : Z180K30GramOperatorDataV16) (k : Fin 6) :
    ∃ q : Real, ∀ r s, r ≠ s ->
...
theorem Z180K30GramOperatorDataV16.sum_eigenvalue_eq_thirtySix
    (data : Z180K30GramOperatorDataV16) (r : Fin 5) :
  ...
  simp_rw [z180_k30_joint_coordinate_pilot_v15 data.core r] at ht
  exact_mod_cast ht

noncomputable def Z180K30GramOperatorDataV16.toJointEigenvalueData
    (data : Z180K30GramOperatorDataV16) :
...
theorem Z180K30GramOperatorDataV16.dichotomy
    (data : Z180K30GramOperatorDataV16) :
...
#print axioms Z180K30GramOperatorDataV16.dichotomy
