...
/-!
Range subshard 3 of the fixed missing-order index 4 check.
The first clique vertex satisfies `90 ≤ z.val ∧ z.val < 120`.
...
theorem z180_k18_m12_missingOrderColor_separates_shard_4_range_3 :
    ∀ z w : ZMod 180,
      90 ≤ z.val ∧ z.val < 120 →
...
#print axioms z180_k18_m12_missingOrderColor_separates_shard_4_range_3
