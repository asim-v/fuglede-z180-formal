...
theorem quadratic_third_root_is_one_of_two_v72Fix
    {A B C x y z : Complex}
    (hA : A ≠ 0) (hxy : x ≠ y)
    (hx : A * x ^ 2 + B * x + C = 0)
    (hy : A * y ^ 2 + B * y + C = 0)
...
theorem unit_affine_phase_has_two_values_v72Fix
  ...
  · have hexists : ∃ j, t j ≠ t 0 := not_forall.mp hall
    ...
    refine ⟨0, q, ?_⟩
    intro j
    exact quadratic_third_root_is_one_of_two_v72Fix
      hleading hq.symm (hquadratic 0) (hquadratic q) (hquadratic j)

#print axioms quadratic_third_root_is_one_of_two_v72Fix
#print axioms unit_affine_phase_has_two_values_v72Fix
