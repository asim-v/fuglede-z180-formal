import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicLeaf00PilotV97
import Fuglede.Z180K30ExceptionalProjectiveProfileD4UAlgebraicKeyDisjointRow01PilotV97

/-! Pairwise key-disjointness row 0; every decision compares two chunks of at most ten keys. -/

namespace Fuglede.Z180K30ExceptionalRawV2

theorem z180_k30_projective_d4_u_key_disjoint_row_00_pilot_v97 :
    List.Pairwise List.Disjoint [z180K30ProjectiveD4ULeaf00KeysPilotV97,
    z180K30ProjectiveD4ULeaf01KeysPilotV97,
    z180K30ProjectiveD4ULeaf02KeysPilotV97,
    z180K30ProjectiveD4ULeaf03KeysPilotV97,
    z180K30ProjectiveD4ULeaf04KeysPilotV97,
    z180K30ProjectiveD4ULeaf05KeysPilotV97,
    z180K30ProjectiveD4ULeaf06KeysPilotV97,
    z180K30ProjectiveD4ULeaf07KeysPilotV97,
  ...
  · intro values hvalues
    ...
    rcases hvalues with (rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl) <;>
      (rw [List.disjoint_left]; decide)
  · exact z180_k30_projective_d4_u_key_disjoint_row_01_pilot_v97
