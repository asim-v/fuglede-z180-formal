...
theorem z180_k18_m12_unwantedColor_separates_shard_2_z_132 :
    ∀ d : ZMod 180,
      ...
      ∀ w : ZMod 180,
        ...
        (132 : ZMod 180) ≠ w →
        z180K18M12UnwantedColor (2 : Fin 3) d (132 : ZMod 180) ≠
          z180K18M12UnwantedColor (2 : Fin 3) d w := by
  decide

#print axioms z180_k18_m12_unwantedColor_separates_shard_2_z_132
