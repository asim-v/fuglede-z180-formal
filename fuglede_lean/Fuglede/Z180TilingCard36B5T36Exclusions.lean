import Fuglede.Z180TilingCard36Order18
...
/-- The large-order exclusions forced by transform zeros at orders 5 and 36. -/
theorem z180_card_five_exclusions_of_transform_five_thirty_six_zero
    {B : Finset (ZMod 180)} (hcard : B.card = 5)
    (h5 : z180ExactOrderTransform B 5 = 0)
    (h36 : z180ExactOrderTransform B 36 = 0) :
  ...
  simp only [z180ExactOrderTransform] at h5 h36
  refine ⟨?_, ?_, ?_⟩
  · intro hx
...
/-- With the additional order-20 zero, order 45 cannot vanish. -/
theorem z180_card_five_excludes_forty_five_of_five_thirty_six_twenty
    {B : Finset (ZMod 180)} (hcard : B.card = 5)
    (h5 : z180ExactOrderTransform B 5 = 0)
    (h36 : z180ExactOrderTransform B 36 = 0)
    (h20 : z180ExactOrderTransform B 20 = 0) :
  ...
  rw [hcardSqCast] at hsum
  clear hcard hcardCast hcardSqCast
  simp only [z180ExactOrderTransform] at h5 h20 h36
  intro h45
  simp only [z180ExactOrderTransform] at h45
  linarith

#print axioms z180_card_five_exclusions_of_transform_five_thirty_six_zero
#print axioms z180_card_five_excludes_forty_five_of_five_thirty_six_twenty
