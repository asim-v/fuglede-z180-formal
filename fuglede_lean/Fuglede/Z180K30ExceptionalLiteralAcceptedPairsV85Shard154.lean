...
/-! Literal accepted-pair coverage shard 154; no choose/drop reconstruction. -/

namespace Fuglede.Z180K30ExceptionalRawV2

def z180K30ExceptionalLiteralAcceptedPairsV85Shard154 :
    List (RawSet × RawSet) :=
  [
...
theorem z180_k30_exceptional_literal_accepted_pairs_v85_shard154 :
    z180K30ExceptionalLiteralAcceptedPairsV85Shard154.all
