...
import Fuglede.Z180K18M12UnwantedColorShard1Z138
...
theorem z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_3 :
    ∀ d : ZMod 180,
    ...
    have hzEq : z = (138 : ZMod 180) := by
      ...
      calc
        ...
        _ = ((138 : ZMod 180).val) := by
          decide
    subst z
    exact z180_k18_m12_unwantedColor_separates_shard_1_z_138
...
#print axioms z180_k18_m12_unwantedColor_separates_shard_1_range_4_slice_3
