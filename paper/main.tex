...
\begin{@twocolumnfalse}
  ...
  \small
  \textbf{Abstract.}
  This article presents a machine-checked proof of the spectral-to-tiling
  implication for
  ...
  argument handles the coupled five-row Gram data.  These certificates are
  joined
...
$p^nqr$~\cite{Zhang2022}.  These results provide the closest arithmetic
context for the present theorem.  The modulus $180=2^2\cdot3^2\cdot5$ lies
outside those one-repeated-prime and square-free families because two
distinct prime factors occur with exponent two.

This article reports a complete formal proof of the spectral-to-tiling
direction for $G=\Zmod{180}$.  The modulus
\[
...
The public Lean endpoint is short enough to display in full.
...
\begin{itemize}
  ...
  \item Spectrality is the exact cyclotomic predicate displayed in
    Section~2, and Equation~\eqref{eq:fourier-bridge} identifies it with the
    usual finite Fourier definition; no approximate vanishing is assumed.
